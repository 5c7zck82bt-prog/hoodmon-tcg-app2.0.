...
export function switchActiveWithReserve(state: GameState, playerId: PlayerId, reserveIndex: 0 | 1 | 2): GameState {
  if (state.status !== "active") throw new Error("Game is not accepting movement right now.");
...
export function promoteReserveToActive(state: GameState, playerId: PlayerId, reserveIndex: 0 | 1 | 2): GameState {
